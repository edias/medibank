...
struct ObservableSelectionStorageTests {
    ...
    func toggleSelectionForwardsCallToUnderlyingStorage() throws {
        ...
        observableStorage.toggleSelection(for: testSource)
    ...
    func isSelectedForwardsCallToUnderlyingStorage() throws {
        ...
        let result = observableStorage.isSelected(testSource)
    ...
    func multipleTogglesReflectInObservableSelections() async throws {
        ...
        // Toggle first source
        observableStorage.toggleSelection(for: source1)
        ...
        observableStorage.toggleSelection(for: source2)
        mockStorage.selections = ["source1", "source2"]
...
private class MockSelectionStorage: SelectionStorage {
    ...
    func toggleSelection(for source: Source) {
        ...
        lastToggledSourceId = source.id
    }
    
    func isSelected(_ source: Source) -> Bool {
        isSelectedCallCount += 1
        lastCheckedSourceId = source.id
